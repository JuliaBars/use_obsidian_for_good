...
Больше года наполняю своя базу знаний, однажды поняла, что никак ее не использую и надо это менять...
...
- в появившемся списке выбрать Tamlates/todo
...
Также дполнительно положила шаблон который создает любую заметку с заранее назначенными полями Свойств (Properties)
